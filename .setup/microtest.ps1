# Micro-test: single setblock + immediate counter check, all responses visible.
...
Invoke-Rcon $stream 'forceload add -16 -16 16 16'
Start-Sleep -Seconds 2

Invoke-Rcon $stream 'entityfix status' | Out-Null
Invoke-Rcon $stream 'setblock 0 90 0 minecraft:stone'
Invoke-Rcon $stream 'setblock 1 91 0 minecraft:diamond_ore'
Invoke-Rcon $stream 'summon minecraft:villager 3 95 3'
Start-Sleep -Seconds 5

$out = Invoke-Rcon $stream 'entityfix status'
Write-Output $out
